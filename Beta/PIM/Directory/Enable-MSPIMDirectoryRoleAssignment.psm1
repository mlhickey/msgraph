function Enable-MSPIMDirectoryRoleAssignment
{
    ...
    process
    {
        ...
        Set-MSGObject -Debug:$DebugPreference -Verbose:$VerbosePreference -Type 'privilegedAccess/aadroles/roleAssignmentRequests' -Body $roleRequest -Method POST -ObjectName 'MSPIM'
    }
}
