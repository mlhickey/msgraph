function Get-MSGUserOwnedDevice
{
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
    The Get-MSGUserOwnedDevice cmdlet gets information about specified user in Azure Active Directory (Azure AD) and the associated owned devices:
    ...
    process
    {
        ...
        $typeString = "users/{0}/ownedDevices" -f $Id
